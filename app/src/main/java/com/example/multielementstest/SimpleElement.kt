...
/*
    ...
    override fun onSurfaceTextureAvailable(surfaceTexture: SurfaceTexture?, width: Int, height: Int) {
        ...
        buildCodec(surfaceTexture)
    }
    // this can be called by onSurfaceTextureAvailable or straight away
    // in the constructor if the SurfaceTexture is already available (and there's no need for event listener)
    fun buildCodec(surfaceTexture: SurfaceTexture?) {
